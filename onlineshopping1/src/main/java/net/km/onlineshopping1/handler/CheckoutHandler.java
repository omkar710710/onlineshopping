...
import net.km.onlineshopping1.model.CheckoutModel;
...
import net.km.shoppingbackend1.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public List<Address> getShippingAddresses(CheckoutModel model) {
		...
		List<Address> addresses = userDAO.listShippingAddress(user.getId());
